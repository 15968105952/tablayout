...
public class TabLayout extends HorizontalScrollView {
    ...
    private static final int TAB_MIN_WIDTH_MARGIN = 20; //dps
...
//        mTabStrip.setBackgroundResource(R.drawable.gradient_shape_tab);
...
//        mScrollableTabMinWidth = res.getDimensionPixelSize(android.support.design.R.dimen.design_tab_scrollable_min_width);
    ...
    class TabView extends LinearLayout {
        ...
        final void update() {
            ...
            if (mCustomView == null) {
                // If there isn't a custom view, we'll us our own in-built layout
                if (mIconView == null) {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        SlidingTabStrip(Context context) {
            ...
            mSelectedIndicatorPaint.setStrokeWidth(5);
        }
...
//                    }
                 ...
                 //解决3个或者3个以上tab无法展示下划线的问题
                    ...
                    RectF rectF = new RectF(left,
                            ...
                            getHeight());
//
////                    firstColor=Integer.valueOf(ApplicationUtils.getString(R.string.firstColor));
////                    secondColor=Integer.valueOf(ApplicationUtils.getString(R.string.secondColor));
//                    LinearGradient mLinearGradient = new LinearGradient(left, getHeight() - mSelectedIndicatorHeight, right, getHeight(),
//                            new int[]{firstColor, secondColor}, null,
//                            Shader.TileMode.REPEAT);
//                    mSelectedIndicatorPaint.setShader(mLinearGradient);
//                    canvas.drawRoundRect(rectF, 5, 5, mSelectedIndicatorPaint);
                    canvas.drawRoundRect(rectF, 5, 5, mSelectedIndicatorPaint);
...
//                    LinearGradient mLinearGradient = new LinearGradient(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight, mIndicatorRight, getHeight(),
//                            new int[]{firstColor, secondColor}, null,
//                            Shader.TileMode.REPEAT);
//                    mSelectedIndicatorPaint.setShader(mLinearGradient);
//                    canvas.drawRoundRect(rectF, 5, 5, mSelectedIndicatorPaint);
